...
public class Modulo7Thaireliz {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("7. Calcular potencia (base^exponente)");
    ...
    public static void calcularPotencia(Scanner scanner) {
        ...
        if (exponente < 0) {
            System.out.println("⚠️ El exponente debe ser un número entero no negativo.");
            return;
        }
        ...
        String mensaje = base + "^" + exponente + " = " + resultado;
        System.out.println("\n✅ Resultado: " + mensaje);
