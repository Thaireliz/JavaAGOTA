...
class Producto {
    ...
    public void duplicarInventario() {
        if (getDisponibilidad() == 0) {
            ...
            System.out.printf("⚠️ No se puede duplicar %s: aún quedan %d unidades disponibles.\n",
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("=========================================");
        System.out.println("   Gestión de Inventario - Tienda de Zapatos   ");
        System.out.println("=========================================");
        System.out.printf("¡Bienvenido! Administra tu inventario fácilmente.\n");
        ...
        while (true) {
            ...
            if (opcion == 1) {
                ...
                System.out.println("\n=========================================");
                System.out.println("   Gracias por usar Gestión de Inventario   ");
                System.out.println("=========================================");
                break;
